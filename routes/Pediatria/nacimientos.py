...
@baby.get("/nacimientos/", response_model=List[schemas.Pediatria.nacimientos.Baby], tags=['Nacimientos'])
...
@baby.get("/nacimiento/{id}/", response_model=schemas.Pediatria.nacimientos.Baby, tags=  ['Nacimientos'])
...
@baby.post("/nacimiento/", response_model=schemas.Pediatria.nacimientos.Baby, tags=["Nacimientos"])
...
@baby.put("/nacimientoput/{id}", response_model=schemas.Pediatria.nacimientos.Baby, tags=["Nacimientos"])
...
@baby.delete("/nacimiento/{id}", response_model=schemas.Pediatria.nacimientos.Baby, tags=["Nacimientos"])
